...
#     checkpoint_path = os.path.join(hp.checkpoint_path, "checkpoint_{}.pth.tar".format(num))
    checkpoint_path = '/home/ubuntu/workspace/Fastspeech2-Korean/ckpt/kss/checkpoint_550000.pth.tar'
...
#     mean_energy, std_energy = torch.tensor(np.load(os.path.join(hp.preprocessed_path, "energy_stat.npy")), dtype=torch.float).to(device)
    mean_mel, std_mel = torch.tensor(np.load("/home/ubuntu/workspace/Fastspeech2-Korean/preprocessed/kss/mel_stat.npy"), dtype=torch.float).to(device)
    mean_f0, std_f0 = torch.tensor(np.load("/home/ubuntu/workspace/Fastspeech2-Korean/preprocessed/kss/f0_stat.npy"), dtype=torch.float).to(device)
    mean_energy, std_energy = torch.tensor(np.load("/home/ubuntu/workspace/Fastspeech2-Korean/preprocessed/kss/energy_stat.npy"), dtype=torch.float).to(device)
